...
func TestGetTranscript_ReturnsSegments(t *testing.T) {
	...
	mock.ExpectQuery(`SELECT transcript_status, transcript_json FROM videos WHERE id = \$1 AND user_id = \$2 AND organization_id IS NOT DISTINCT FROM \$3 AND status != 'deleted'`).
